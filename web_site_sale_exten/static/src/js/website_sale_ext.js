...
$('.oe_website_sale').each(function () {
 ...
 $(oe_website_sale).on("change", "div.css_quantity input.tooltipt", function () {
        var $input = $(this);
	  ...
	  if(variant_qty==undefined){    
		...
		$( "#add_to_cart" ).addClass("difuse");
	    }
	    else
	    {
		$( "#add_to_cart" ).removeClass("difuse");
	    }
	  }
...
$('.a-submit', oe_website_sale).off('click').on('click', function () {
        var product_added_Dict = $( "div.popover-content" ).text();  
